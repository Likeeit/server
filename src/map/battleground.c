...
{ // Respawn after killed
	...
	status_change_start(&sd->bl,SC_BLESSING,10000,10,0,0,0,240000,0);
	status_change_start(&sd->bl,SC_INCREASEAGI,10000,10,0,0,0,240000,0);
...
int queue_leave2(struct map_session_data *sd, int q_id)
{
	struct queue_data *qd;
