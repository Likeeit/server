...
int battle_check_target( struct block_list *src, struct block_list *target,int flag)
{
	...
	{ //Non pvp/gvg, check party/guild settings.
		if( battle_config.guild_wars && !map_flag_noguildwar(m) && !agit_flag )
		{
			int s_guild = status_get_guild_id(s_bl);
			int t_guild = status_get_guild_id(t_bl);
...
// Helrouis' additions
	{ "refresh_delay",               &battle_config.refresh_delay,            2000,      0,      INT_MAX,              },
	{ "bg_strict_mode_by_helrouis",               &battle_config.bg_strict_mode,            0,      0,      INT_MAX,              },
	{ "afk_point_gain",              	     &battle_config.afk_point_gain,                  1,      1,      100,              },
	{ "activity_point_gain",                &battle_config.activity_point_gain,             1,      1,      100,              },
	{ "chatroom_max_msg",                &battle_config.chatroom_max_msg,			    30,      1,      INT_MAX,              },
};
